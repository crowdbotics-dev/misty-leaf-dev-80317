"""
Django settings for misty_leaf_dev_80317 project.
...
ROOT_URLCONF = 'misty_leaf_dev_80317.urls'
...
WSGI_APPLICATION = 'misty_leaf_dev_80317.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_leaf_dev_80317 API",
    "DESCRIPTION": "API documentation for misty_leaf_dev_80317 App",
    "VERSION": "v1",
}
